...
T = {
 ...
 "stock-return":("internal_return",[("party","String"),("condition","String"),("originalDocumentNo","String"),("originalIssueType","String"),("jobOrderNo","String"),("reasonCode","String"),("inspectionRequired","String"),("reduceConsumption","String")],"internal_return_line",[("returnedQty","double"),("acceptedQty","Double"),("rejectedQty","Double"),("stockStatus","String")],"returnedQty",True),
