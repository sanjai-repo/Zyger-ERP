...
@Entity @Table(name="invoice_return_line") @Getter @Setter
public class InvoiceReturnLine extends BaseLine implements LineEntity {
    ...
    @Column(name="original_invoice_qty") BigDecimal originalInvoiceQty;
