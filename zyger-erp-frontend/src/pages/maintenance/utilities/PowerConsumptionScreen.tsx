        ...
        <div className="panel">
          ...
          <div className="twrap">
            {loading ? <div className="empty"><span className="material-symbols-rounded">hourglass_empty</span> Loading...</div> : (
              <table className="tbl">
                <thead><tr><th className="num">S.No</th><th>PWC No</th><th>Date</th><th>Machine</th><th>Meter</th><th>Opening</th><th>Closing</th><th>Consumption</th><th>Unit</th><th>Status</th><th>Actions</th></tr></thead>
                <tbody>
                  {filtered.length === 0 ? <tr><td colSpan={11}><div className="empty"><span className="material-symbols-rounded">description</span> No power entries.</div></td></tr> : filtered.map((r, idx) => (
                    <tr key={r.id}>
